...
To verify the results between sw and hw side, you can execute `inference.py` under `TrackGNN/model/', and the script will automatically generates the software side results for comparison.
